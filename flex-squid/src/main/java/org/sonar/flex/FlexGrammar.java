...
public enum FlexGrammar implements GrammarRuleKey {
  ...
  private static void cExpressions(LexerlessGrammarBuilder b) {
    ...
    b.rule(POSTFIX_EXPR).is(
        ...
        b.zeroOrMore(b.firstOf(
            ...
            b.sequence(DOT, IDENTIFIER), // a.b
            b.sequence(ARROW, IDENTIFIER), // a->b
            DOUBLE_PLUS, // a++
            DOUBLE_MINUS // a--
        )));
  ...
  private static void expressions(LexerlessGrammarBuilder b) {
    ...
    b.rule(COMPOUND_ASSIGNMENT).is(
        b.firstOf(STAR_EQU, DIV_EQU, MOD_EQU, PLUS_EQU, MINUS_EQU, SL_EQU, SR_EQU, SR_EQU2, AND_EQU, XOR_EQU, OR_EQU));
    ...
    b.rule(LOGICAL_AND_EXPR_NO_IN)
        .is(BITEWISE_OR_EXPR_NO_IN, b.zeroOrMore(LOGICAL_AND_OPERATOR, BITEWISE_XOR_EXPR_NO_IN)).skipIfOneChild();
    ...
    b.rule(LOGICAL_OR_EXPR_NO_IN).is(LOGICAL_AND_EXPR_NO_IN, b.zeroOrMore(LOGICAL_OR_OPERATOR, LOGICAL_AND_EXPR_NO_IN))
        .skipIfOneChild();
    ...
    b.rule(NON_ASSIGNMENT_EXPR_NO_IN)
        .is(LOGICAL_OR_EXPR_NO_IN, b.optional(QUERY, NON_ASSIGNMENT_EXPR_NO_IN, COLON, NON_ASSIGNMENT_EXPR_NO_IN))
        .skipIfOneChild();
  ...
  private static void statements(LexerlessGrammarBuilder b) {
    ...
    b.rule(FOR_STATEMENT).is(b.firstOf(
        b.sequence(FOR, LPARENTHESIS, b.optional(FOR_INITIALISER), SEMICOLON, b.optional(LIST_EXPRESSION), SEMICOLON,
        ...
        b.sequence(FOR, b.sequence(/* No line break */ SPACING_NO_LB, NEXT_NOT_LB, EACH, LPARENTHESIS, FOR_IN_BINDING,
